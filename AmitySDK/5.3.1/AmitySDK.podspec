Pod::Spec.new do |s|
    ...
    s.source       = { :http => 'https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios/5.3.1/amitysdk.zip' }
    s.vendored_frameworks = 'amitysdk/Frameworks/AmitySDK.xcframework', 'amitysdk/Frameworks/Realm.xcframework'
    s.platform = :ios
    s.swift_version = "5"
